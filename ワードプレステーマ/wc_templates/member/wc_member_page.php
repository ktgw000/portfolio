<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/accountPage.css">
<?php
/**
...
<div id="accountPage" class="catbox">
				...
				<div class="whitebox">
					...
					<table>
						<tr>
							...
							<td rowspan="3">&nbsp;</td>
							<!-- 登録日 <th><?php _e('Strated date', 'usces'); ?></th>
					...
					<h3 id="accountInfomationEdit">お届け先情報</h3>
					<div class="error_message"><?php usces_error_message(); ?></div>
					<form id="accountInfomationEditContent" action="<?php usces_url('member'); ?>#edit" method="post" onKeyDown="if (event.keyCode == 13) {return false;}">
						...
						<div class="send">
							...
							<!-- 退会 <input name="deletemember" type="submit" value="<?php _e('delete it', 'usces'); ?>" onclick="return confirm('<?php _e('All information about the member is deleted. Are you all right?', 'usces'); ?>');" /> -->
						</div>
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/accountPage.js"></script>
